...
.data
	...
	num_X1:		.double	0					# left point integration
	num_X2:		.double	17					# rigth point integration
	num_R:		.asciz	"Function is not defined at point 0 (zero)."	# expected ruslt
	funcT_custom_data:
			.double	1.56	# the A - item of target function
			.double	-2.7	# the B - item of target function
