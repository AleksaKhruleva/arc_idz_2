...
.data
	...
	num_X1:		.double	-3					# left point integration
	num_X2:		.double	10					# rigth point integration
	num_R:		.asciz	"Function is not defined at point 0 (zero)."	# expected ruslt
	funcT_custom_data:
			.double	2	# the A - item of target function
			.double	5	# the B - item of target function
