...
.data
	...
	num_X1:		.double	1			# left point integration
	num_X2:		.double	5			# rigth point integration
	num_R:		.double	227.19999799389902	# expected ruslt
	funcT_custom_data:
			.double	57	# the A - item of target function
